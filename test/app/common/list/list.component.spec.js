System.register(['../../../../app/common/list/list.service', '../../../../app/common/list/list.component', 'angular2/http/testing', 'angular2/core', 'angular2/http'], function(exports_1) {
    var list_service_1, list_component_1, testing_1, core_1, http_1;
    return {
        setters:[
        ...
        execute: function() {
            describe('ListComponent', function () {
                var http, backend, connection, listService, listComponent;
                var responseBody = {
                    items: [
                        {
                            _id: 1,
                ...
                beforeEach(function () {
                    ...
                    listService = new list_service_1.ListService(http);
                    listComponent = new list_component_1.ListComponent(listService);
                });
                ...
                it('should load page with http request as a source on ngOnChanges', function (done) {
